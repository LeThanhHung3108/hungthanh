                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input value="${detail.stockQuantity}" name="stockquantity="text" class="form-control"  required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="descriptsion" class="form-control" required>${detail.description}</textarea>
                            </div>
